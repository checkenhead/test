		...
		<table>
			<tr>
				<td width="800" align="right">
					<input class="btn" type="button" name="btn_write" value="새배너 등록" onClick="location.href='newBannerWrite'">
				</td>
			</tr>
		</table>
				...
				<c:otherwise>
					<c:forEach items="${bannerList}" var="bannerVO">
						<tr>
							...
							<td align="center" style="text-align: left; padding-left: 50px; padding-right: 0px; width: 300px;">
								${bannerVO.SUBJECT}
							</td>
							<td>
							...
							<td align="center">${bannerVO.USEYN}</td>
							<td align="center" width="150"><fmt:formatDate value="${bannerVO.INDATE}" /></td>
							<td align="center">
								<input type="button" value="수정" onClick="location.href='editBannerForm?bseq=${bannerVO.BSEQ}'">
							</td>
						</tr>
					</c:forEach>
				</c:otherwise>
