...
<article>
	...
	<form name="frm" method="post">
		<table id="list">
			...
			<tr>
				<th>상품명</th>
				<td width="343" colspan="5"><input type="text" name="name" size="47" maxlength="100"></td>
			</tr>
			<tr>
				<th>원가[A]</th><td width="70"><input type="text" name="price1" size="11" onKeyup="cal();"></td>
				<th>판매가[B]</th><td width="70"><input type="text" name="price2" size="11" onKeyup="cal();"></td>
				<th>[B-A]</th><td width="72"><input type="text" name="price3" size="11"></td>
			</tr>
			<tr>
				<th>상세설명</th>
			...
			<tr height="200">
				...
				<td width="343" colspan="5" style="vertical-align: top;">
					<input type="hidden" name="image" id="image"><!-- 전송용 파일 이름 -->
					<div id="filename"></div><!-- 브라우저 표시용 파일 이름 -->
				</td>
			</tr>
