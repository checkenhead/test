...
<article>
	<h2>Join Us</h2>${message}
	<form name="joinFrm" id="join" action="join" method="post">
		<fieldset>
			<legend>Basic Info</legend>
			<label>User ID</label>
			<input type="text" name="userid" size="12" value="${mdto.userid}">
			<input type="hidden" name="reid" value="${reid}">
			<input type="button" class="dup" value="중복체크" onClick="id_check();"><br>
			<label>Password</label><input type="password" name="pwd" size="23"><br>
			<label>Retype Password</label><input type="password" name="pwdCheck" size="23"><br>
		...
		<fieldset>
			...
			<input type="text" id="sample6_postcode" size="34" name="zipnum" readonly>
